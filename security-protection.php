...
function secprot_plugin_meta($links, $file) {
	if ( $file == plugin_basename( __FILE__ ) ) {
		$row_meta = array(
			'support' => '<a href="http://web-profile.net/wordpress/plugins/security-protection/" target="_blank"> ' . __( 'Security-Protection', 'security-protection' ) . '</a>',
			'donate' => '<a href="http://web-profile.net/donate/" target="_blank"> ' . __( 'Donate', 'security-protection' ) . '</a>',
			'pro' => '<a href="http://web-profile.net/wordpress/plugins/" target="_blank" title="WordPress plugins"> ' . __( 'WordPress plugins', 'security-protection' ) . '</a>'
		);
